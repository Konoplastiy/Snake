...
1. Сделать поле
2. Сделать змейку
3. Добавить еду на поле
4. Добавить условие смерти
5. Добавить score
 */
...
public class GameSnake {
    ...
    final int LEFT = 37; // Код клавиши VK_LEFT '←'
    final int UP = 38;  //Код клавиши VK_UP '↑'
    final int RIGHT = 39;  //Код клавиши VK_RIGHT  '→'
    final int DOWN = 40;  //Код клавиши VK_DOWN '↓'
    final int START_DIRECTION = UP;
    ...
    void go() {
        ...
        frame.setSize(FIELD_WIDTH * POINT_RADIUS + FIELD_DX, FIELD_HEIGHT * POINT_RADIUS + FIELD_DY); // Size of window
        frame.setLocation(START_LOCATION, START_LOCATION);
        frame.setResizable(false);  // Change field size

        canvasPanel = new Canvas();
        canvasPanel.setBackground(Color.white);

        frame.getContentPane().add(BorderLayout.CENTER, canvasPanel);
        // Follow keyboard presses
